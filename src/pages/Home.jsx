...
import { StickyScrollRevealDemo } from "./Abouts.jsx";

const Home = () => {
  return (
    <>
      <main className="bg-white min-h-screen container pt-5">
        ...
        <div className="w-full text-center py-10  flex flex-col cursor-pointer">
          <Link to="/Aquaharmony/products">
            ...
            <h1 className="text-lg py-4">
              The next generation of Shower technology is here
            </h1>
            <button className="py-3 px-8 my-2  rounded-full text-white bg-black mx-auto hover:opacity-80">
              Shop Now
            </button>
          </Link>
        </div>
